...
<div class="wrapper">
	<div class="jumbotron text-center bg-warning header">
		<div class="text-white">
			<h4>Tugas Kelompok 5</h4>
			<p>Sitem Informasi dan Reservasi Tiket Kereta Api</p>
		</div>
	</div>
	<div class="container">
			...
			<div class="col-sm-12  overflow-auto">
				<div class="container">
				    ...
				    <form action="" method="post">
				    	<div class="row">
				    		<div class="col-sm-10">
				    			<input type="text" name="keyword" class="form-control" size="10" placeholder="Cari Disini" autofocus autocomplete="off">
				    		</div>
				    		<div class="col-sm-2">
				    			<input type="submit" name="cari" class="form-control btn btn-primary" value="Cari">
				    		</div>
				            ...
				            while ($data = mysqli_fetch_array($SQL) and extract($data)) { 
				             ...
				             ?>
				                <tr>
				                    ...
				                    <td><?= $waktu.$date ?></td>
				                    <?php if(isset($_SESSION['status'])) {?>
				                		<td><a href='order.php?id=<?= $id?>' class="btn btn-warning">Pesan Sekarang</a></td>
			            			<?php }else{ ?>
