<?php 
 ...
 ?>
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4" onclick="window.print()">
            <h1 class="h3 mb-0 text-gray-800">Dashboard</h1>
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Cetak Daftar Pesanan</a>
          </div>          
          <!-- Content Row -->
          <div class="row">
            <!-- Content Column -->
            	...
            	<div class="col-sm-8">
	            	<div class="jumbotron bg-white">
	            		<div class="title mb-2">
	            			<div class="row">
							<h3>Reservasi</h3>
							<a href="../index.php" class="btn btn-primary ml-2">Pesan Tiket Kereta</a>
	            			</div>
